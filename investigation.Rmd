...
ggplot(nyweather, aes(x = wind_spd_avg, y = heat_index_avg)) + geom_point() + labs(title = "Heat index mean plotted against wind speed average") 
...
ggplot(nyweather, aes(x = wind_spd_avg, y = wind_chill_avg)) + geom_point() + labs(title = "wind chill average plotted against wind speed average") 
